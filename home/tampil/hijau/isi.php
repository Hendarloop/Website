  <link rel="shortcut icon" href="http://dprd.bekasikota.go.id/home/dprd.png">
  <?php
  if ($_GET['module']=='home'){?>
  ...
  <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-598037d13a285a7b"></script> 
  <?php
  ...
  <!------------------------ AKHIR KOLOM BERITA ------------------------------>
	...
	<!------------------------ KOLOM BERITA ------------------------------>
		<div class="archive">
			<div class="row">
			<div class=""><a href="semua-playlist.html"><h3>VIDEO TERBARU</h3></a><br>
					  <?php 	  
				      $hari_ini=date("Ymd");
					  ...
					  while($d=mysql_fetch_array($terkini2)){
						  ...
						  echo "
						  <div class='item'>
						  <iframe width='600' height='300' src='$d[youtube]' frameborder='0' allowfullscreen></iframe>
...
<!--<div class="sidebar-item">
	...
	<div class="sidebar-title"><b>VIDEO TERBARU</b></div></div>
	<div class="list"> -->
  <?php   
...
<!-- </div>
  ...
  <div class="sidebar-item">
  <div class="photo-gallery-widget">
  <div class="sidebar-title"><b>DOWNLOAD APK</b></div>
  <div class="photos">
		<a href="https://play.google.com/store/apps/details?id=com.wDPRDKOTABEKASI_4880606&hl=in" target="_blank"><img src="../home/tampil/hijau/images/playstore.png" width="250px;"></a>
  </div>
  </div>
  </div>
  <!----------- AKHIR PLAY STORE ------------------------>
