  ...
  echo "<a href='$iden[url]'><img width='950px' height='200px' src='logo/$b[gambar]'/ style='margin-left:60px';></a>";}
  ?></div>
  <!------------------------- AKHIR LOGO --------------------------------->	
 ...
 <form method="POST" action="hasil-pencarian.html">
  ...
  <!-- Copyright © <?php //$tahun=date("Y"); echo "$tahun. "; include "nama_web.php"; ?>. Developed by <?php //include "nama_pemilik.php";?> -->
	Copyright &copy; 2017 DPRD Kota Bekasi
	<div style="float:right">
	<?php
		 echo "<class='user'>Online: <span class style=\"color:#008C43;\">$pengunjungonline </span>
               <class='hits'>Hits: <span class style=\"color:#008C43;\">$hits[hitstoday]</span> / $totalhits ";
