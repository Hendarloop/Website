          ...
          <ul class="nav navbar-nav custom_nav">
            ...
            <li class="dropdown"><a href="#">Komisi</a>
				<ul class="dropdown-menu" role="menu">
					...
					<li><a href="komisi-a.php">Komisi A</a></li>
					<li><a href="komisi-b.php">Komisi B</a></li>
					<li><a href="komisi-c.php">Komisi C</a></li> 
					<li><a href="komisi-d.php">Komisi D</a></li>
				 </ul>	
			</li>
        ...
        <div class="row">
          <div class="leftbar_content">
            ...
            <div class="single_stuff wow fadeInDown">
              <div class="single_stuff_img"> <a href="<? $row['id_berita'] ?>"><img src="../foto_berita/<?= $row['gambar']; ?>" alt=""></a> </div>
                ...
                <div class="single_sarticle_inner"> <a class="stuff_category" href="#"></a>
                  <div class="stuff_article_inner"> <span class="stuff_date"><strong><?php echo date('d M '); ?></strong></span>
                    ...
                    <p><?=substr($row['isi_berita'], 0, 150)?>
					   <font color="#0000FF"><i><? echo "<a href='artikel_detail.php?id=$row[0]'>Selengkapnya...</a>"; ?></i></font></p>
                  </div>
                </div> 
              </div>
            </div>
