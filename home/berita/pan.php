              ...
              <div class="single_stuff_article">
                <div class="single_sarticle_inner">
                  <div class="stuff_article_inner"> <span class="stuff_date">Nov <strong>17</strong></span>
                    <h2>ANGGOTA FRAKSI PAN</h2><br><br><br>
                    <table border="1">
							<div><tr bgcolor="#7dc34d" height="40px"><th width="20%"> &nbsp; Nama</th>
									 <th width="10%"> &nbsp; Alamat</th>
									 <th width="5%">&nbsp;Dapil </th></tr></div>
							<div><tr><td>&nbsp;H.Abdul Muien Harid, SE</td><td>&nbsp;	Pejuang Jaya Blok B-192 RT/RW. 013/011 Kel. Pejuang</td><td>&nbsp;V (Lima)</td></tr></div>
							<div><tr><td>&nbsp;H.Syamsul Bahri, SH</td><td>&nbsp;Kp. Cakung Rt.02/012 Kel. Jati Mekar Kec. Jati Asih</td><td>&nbsp;III (Tiga)</td></tr></div>
							<div><tr><td>&nbsp;Drs.H. Laode M Agus</td><td>&nbsp;Jl. Borneo Utara IX Blok C No.148 Rt.04/010 Bojong Menteng</td><td>&nbsp;II(Dua)</td></tr></div>
							<div><tr><td>&nbsp;H. Safril</td><td>&nbsp;	Kom.Duta Indah Jl. Mawar Blok M No.1 Jati Makmur Pondok Gede</td><td>&nbsp;IV (Empat)</td></tr></div>
					   </table><br><br>
                  </div>
                </div> 
              </div>
