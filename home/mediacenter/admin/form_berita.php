...
<?php include('akses.php'); ?>
	...
	<h3><font face="Cooper Black"> &nbsp; &nbsp;Tambah Berita</font></h3>
	...
	<form action="tambah_berita.php" method="POST" enctype="multipart/form-data">
		<table cellpadding="3" cellspacing="0" class="table table-bordered border">
			...
			<tr>
				...
				<td><div class="col-sm-6"><input type="text" name="waktu" class="form-control" placeholder="Waktu" size="30" required></div></td>
			</tr>
