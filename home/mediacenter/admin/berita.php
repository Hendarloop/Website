...
<script type="text/javascript" language="JavaScript">
	...
	<h3><font face="Cooper Black"> &nbsp; &nbsp; KUMPULAN BERITA </font></h3>
	...
	<?php
		...
		$query = mysql_query("SELECT * FROM tabel_berita ORDER BY id_berita DESC LIMIT 6") or die(mysql_error());		
	...
	<?php
		echo '<td align=center><a href="edit_berita.php?id='.$data['id_berita'].'">Edit</a>';
	...
	?>
	<p> &nbsp;  &nbsp; <a href="form_berita.php" class="btn btn-primary btn-danger"> Tambah </a> 
	</table>	
</body>
</html>