...
<?php include('akses.php'); ?>
	...
	<h3><font face="Cooper Black"> &nbsp; &nbsp;Tambah Agenda</font></h3>
	...
	<form action="tambah_agenda.php" method="POST" enctype="multipart/form-data">
		<table cellpadding="3" cellspacing="0" class="table table-bordered border">
			<tr>
				...
				<td><div class="col-sm-6"><input type="text" id="tgl" name="tgl" class="form-control" placeholder="Tanggal Agenda" size="30" required></div></td>
			</tr>
			<tr>
				<td width="200">Jam</td>
				<td><div class="col-sm-6"><input type="time" name="jam" class="form-control" placeholder="Jam" size="60" required></div></td>
			</tr>
			<tr>
				<td width="200">Agenda</td>
				<td><div class="col-sm-6"><textarea rows="5" cols="50" class="form-control" name="agenda" maxlength="60" placeholder="Agenda"></textarea></div></td>
			</tr>
			<tr>
				<td width="200">Tempat</td>
				<td><div class="col-sm-6"><input type="text" name="tempat" class="form-control" maxlength="60" placeholder="Tempat" size="30" required></div></td>
			</tr>
			<tr>
				<td width="200">Keterangan</td>
				<td><div class="col-sm-6"><input type="text" name="keterangan" class="form-control" maxlength="60" placeholder="Keterangan" size="30" required></div></td>
			</tr>
